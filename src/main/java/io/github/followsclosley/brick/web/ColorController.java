...
public class ColorController {
    ...
    Page<ColorDto> getColorsByName(@PathVariable(name = "version", required = false) String version, @Param("name") String name, Pageable pageable) {
    ...
    ColorDto getColor(@PathVariable(name = "version", required = false) String version, @PathVariable String id) {
